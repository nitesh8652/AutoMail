...
const StatusCard = ({ company, status, email }) => {
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-[#e3edf4] bg-white px-5 py-4 shadow-[0_8px_24px_rgba(22,65,96,0.06)] transition hover:-translate-y-px hover:shadow-[0_12px_32px_rgba(22,65,96,0.1)]">
      <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl ${isReceived ? 'bg-green-100' : 'bg-red-100'}`}>
        {isReceived ? (
      ...
      <div className="min-w-0 flex-1">
        <h3 className="truncate text-[15px] font-extrabold tracking-[-0.01em] text-[#102a43]">{company}</h3>
